...
export default {
  getInfoById,
  queryCircularManagementInfoList,
  saveAdd,
  saveEditAdd,
  moveCircularManagementInfo,
  sendCircularManagementInfo,
  queryCircularManagementReceiveListById,
  backCircularManagementInfo,
  queryCircularManagementReceiveList,
  receiveCircularManagementInfo,
  getParameterCompanyCircularCategory,
  getInfoHisById
}