...
// 申请-申请单详情导出
// 获得下载文件URl
export function materialExport(id) {
...
// 物料管理->物料分类列表
export function getMaterielDeviceTypeList(data) {
  return request({
...
// 物料管理->新增保存物料分类列表
export function saveMaterielDeviceType(data) {
  return request({
...
// 物料管理->编辑保存物料分类列表
export function saveMaterielDeviceTypeModify(data) {
  return request({
...
// 物料管理->删除物料分类列表
export function delMaterielDeviceType(data) {
  return request({
...
// 船载物料->拖动排序物料分类列表
export function orderMaterielDeviceType(data) {
  return request({
...
export function materielPartInfoInsert(data) {
  return request({
...
// 船载物料 -> 编辑物料
export function materielPartInfoUpdate(data) {
  return request({
...
// 船载物料 -> 删除物料
export function deleteSupplyMaterielInfo(data) {
  return request({
...
// 船载物料->物料分类树
export function maDeviceTree(data) {
  return request({
    url: "/supplyMaterielTypeInfo/query/selectList",
    method: "get",
    params: data
...
// 船载物料 -> 分页查询
export function selectMaterielPartInfoPage(data) {
  return request({
...
// 船载物料 -> 审核通过
export function auditSupplyMaterielInfo(data) {
  return request({
...
// #region ipma6物料
// 获取impa6分类
export function maImpaDeviceTree(data) {
  return request({
...
// 获取impa6列表
export function selectImpaMalApplPage(query) {
  return request({
...
// 获取impa6列表明细
export function selectImpaListMoreAppl(query) {
  return request({
...
// 获取申请采购明细列表
// vesselId 船舶ID 必传
export function selectMaApplPageList(query) {
  return request({
...
// 获取申请采购明细新增列表
// vesselId 船舶ID 必传
export function selectMalApplPage(query) {
  return request({
...
// 申请单新增保存接口
export function billaddMaSave(data) {
  return request({
...
// 分页查询
export function supplyMaterielInStoreInfoPage(query) {
  return request({
...
// 查询详情
export function supplyMaterielInStoreInfoDetail(query) {
  return request({
...
// 强制关闭
export function supplyMaterielInStoreInfoForceClose(data) {
  return request({
...
// 入库
export function supplyMaterielInStoreInfoInStore(data) {
  return request({
...
// 提交签收单
export function supplyMaterielInStoreInfoSubmitBill(data) {
  return request({
...
export function supplyMaterielInfoPage(query) {
  return request({
...
// 查询库存盘点列表带分页
export function supplyMaterielCheckStoreInfoSelectPage(query) {
  return request({
...
// 新增库存盘点明细列表
export function supplyMaterielInfoCheckPageList(query) {
  return request({
...
// 新增库存盘点明细保存
export function supplyMaterielCheckStoreInfoSave(data) {
  return request({
...
// 库存盘点.详情查询
export function supplyMaterielCheckStoreInfoSelectDetail(data) {
  return request({
...
// 库存盘点.保存单据详情
export function supplyMaterielCheckSave(data) {
  return request({
...
// 库存盘点.提交单据详情
export function supplyMaterielCheckSubmitBill(data) {
  return request({
...
// 库存盘点.审核确认
export function supplyMaterielCheckStoreInfoVerifyBill(data) {
  return request({
...
export function supplyMaLocationInfoList(query) {
  return request({
...
export function supplyMaLocationInfoSave(data) {
  return request({
...
export function supplyMaLocationInfoDel(data) {
  return request({
...
export function selectMaCheckPageList(query) {
  return request({
...
// 出库-单据列表
export function materielOutStoreInfoSlectPage(query) {
  return request({
...
// 出库-查询物料明细列表
export function selectOutStorePageList(query) {
  return request({
...
// 出库-出库类型为退掉出库之外的出库
export function materielOutStoreInfoAddSpSave(data) {
  return request({
...
// 出库-单据列表(无分页)
export function materielOutStoreInfoSlectList(query) {
  return request({
...
// 出库-单据详情
export function materielOutStoreInfoSelectDetail(query) {
  return request({
...
// 出库-废弃单据状态
export function materielOutStoreInfoCancelBill(data) {
  return request({
...
// 出库-保存单据
export function materielOutStoreInfoSave(data) {
  return request({
...
// 出库-单据审核
export function materielOutStoreInfoVerifyBill(data) {
  return request({
...
// 出库-单据提交
export function materielOutStoreInfoSubmitBill(data) {
  return request({
...
// 出库-根据供船单ID获取供船备件明细
export function materielOutStoreInfoGetInStoreDetail(data) {
  return request({
...
// 物料质量反馈
export function materielQualityPageList(query) {
  return request({
...
// 物料质量反馈详情
export function materielQualityDetail(query) {
  return request({
...
// 物料质量反馈列表页状态
export function materielQualityStatus(query) {
  return request({
...
// 物料质量反馈操作历史
export function materielQualityOperateHis(query) {
  return request({
...
// 物料质量反馈供应商列表
export function materielQualitySupplier(query) {
  return request({
...
// 物料质量反馈保存
export function saveMaterielQuality(data) {
  return request({
...
//物料质量反馈提交
export function submitMaterielQuality(data) {
  return request({
...
// 物料质量反馈确认
export function confirmMaterielQuality(data) {
  return request({
...
// 物料质量反馈提交岸基
export function bankSubmitMaterielQuality(data) {
  return request({
...
// 物料质量反馈普通退回
export function backMaterielQuality(data) {
  return request({
...
// 物料质量反馈审核之后再确认
export function vesselSubmitMaterielQuality(data) {
  return request({
...
// 物料质量反馈审核之后再确认
export function completeConfirmMaterielQuality(data) {
  return request({
...
export function saveMaterielMaterielInfoInsert(data) {
  return request({
    url: "/supplyMaterielInStoreInfo/query/getInStoreDetail",
    method: "get",
    params: data
...
export function saveMaterielMaterielInfoModify(data) {
  return request({
    url: "/supplyMaterielInStoreInfo/query/getInStoreDetail",
    method: "get",
    params: data
