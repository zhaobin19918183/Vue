...
// 查询考评一览列表
export function selectAssessmentIndex(params) {
  return request({
...
// 查询考评详情信息列表
export function selectAssessmentDetails(params) {
  return request({
...
export function saveSubmitAssessmentDetails(data) {
  return request({
...
export function saveSubmitAssessmentDetailsDown(data) {
  return request({
...
export function submitAssessmentDetails(data) {
  return request({
...
//  审核接口
export function reviewThrough(data) {
  return request({
...
export function selectEvaluate(params) {
  return request({
...
// 废弃考评 --- 下船评价得废弃接口
export function abandonedDown(data) {
  return request({
...
// 查询年度考评一览
export function getYearEvaluationPageByCondition(params) {
  return request({
...
// 废弃考评 --- 年度考评得废弃接口
export function saveYearEvaluationDiscard(data) {
  return request({
...
// 判断是否是船端
export function shipSideBol(params) {
  return request({
...
export function attributeService(params) {
  return request({
