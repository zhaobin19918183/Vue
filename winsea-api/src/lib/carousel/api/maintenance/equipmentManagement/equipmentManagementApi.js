...
// 设备管理一览->排序->保存设备信息序号
export function saveDeviceInfoorder(data) {
  return request({
...
export function getReferOtherWrokinfo(data) {
  return request({
...
export function deleteWorkInfoList(data) {
  return request({
...
// 设备管理详细->查询设备工作信息详细
export function getDeviceWorkList(data) {
  return request({
...
export function updateWorkInfoList(data) {
  return request({
...
export function getDeviceTypeById(data) {
  return request({
...
// 设备管理->查询该设备下工作信息条数
export function getDeviceWorkListCount(data) {
  return request({
...
// 设备管理新增->生成设备编码
export function getDeviceCode(data) {
  return request({
