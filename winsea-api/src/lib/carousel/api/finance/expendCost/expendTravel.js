...
// 新增差旅费付款申请
export function addTravelExpensesApply(data) {
  return request({
...
// 修改差旅费付款申请
export function editTravelExpensesApply(data) {
  return request({
...
// 删除差旅费付款申请
export function deleteTravelExpensesApply(data) {
  return request({
...
// 查询差旅费申请详情
export function getTravelExpensesApplyById(data) {
  return request({
...
// 查询差旅费申请检索类别默认值
export function getDefaultTravelSearchType(data) {
  return request({
...
// 查询差旅费原币币种
export function getCurrencyRates(data) {
  return request({
...
// 查询科目
export function getListByConditionSub(data) {
  return request({
...
// 收款人
export function petpayeeListByCondition(data) {
  return request({
...
// 提交差旅费申请
export function submitTravelExpensesApply(data) {
  return request({
...
// 推送出纳付款（差旅费申请）
export function sendToPay(data) {
  return request({
